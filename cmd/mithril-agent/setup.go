...
// detectMithrilCommand finds the public Mithril CLI. The obsolete standalone
// mithril-mcp prototype does not accept the `mcp --profile monitor` arguments
// generated by this agent and must never be selected by name.
func detectMithrilCommand() string {
	return firstNonEmpty(detectInstalled("mithril-node", "mithril"), detectExecutable("mithril"))
}
