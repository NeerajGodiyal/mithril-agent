...
function hermesPerpsCards(packet,invalid){
  ...
  const statuses={pending_advisory:'Proposal saved',already_saved:'Already saved',unavailable:'Check incomplete',cleanup_required:'Cleanup needed',interrupted:'Attempt stopped'};
