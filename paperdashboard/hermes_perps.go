...
func readHermesPerps(path string, now time.Time) (*HermesPerps, error) {
	...
	for _, market := range stored.Markets {
		...
		if market.Status == "pending_advisory" {
			...
			if err != nil || target == 0 || strconv.FormatUint(target, 10) != market.TargetEpisode || market.Phase != "" || !validSHA256(market.ContextSHA256) || !validSHA256(market.ProposalSHA256) || market.TrainingTapes == nil || *market.TrainingTapes < 1 || *market.TrainingTapes > 8 || market.ResolvedOutcomes == nil || *market.ResolvedOutcomes > 8 {
		...
		switch market.Phase {
		case "prepare_directories", "prepare_context", "model_proposal", "export_session", "verify_model_output", "freeze_proposal", "record_invocation":
		default:
			return nil, errors.New("hermes perps attempt phase is invalid")
		}
		if market.TargetEpisode != "" || market.Strategy != "" || market.RiskArm != "" || market.ContextSHA256 != "" || market.ProposalSHA256 != "" || market.TrainingTapes != nil || market.ResolvedOutcomes != nil {
